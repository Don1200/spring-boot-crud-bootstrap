...
public class User implements UserDetails {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return age == user.age && id.equals(user.id) && firstName.equals(user.firstName) && lastName.equals(user.lastName) && email.equals(user.email) && password.equals(user.password) && roles.equals(user.roles);
    }
